---
title: Create a GitHub Profile Pet with GraphQL
author: Vishalya Sairam
uid: kpEBcP0g20SPY0Os4kzO4n656U02
description: Learn how to use the GitHub GraphQL API, Next.js, and SVGs to build an animated pet widget that reflects your GitHub contribution streak on your profile README.
datePublished: 2026-07-04
published: beta
header: https://firebasestorage.googleapis.com/v0/b/codedex-io.appspot.com/o/projects%2Fcreate-a-github-profile-pet-with-graphql%2Fbanner.webp?alt=media
bannerImage: https://firebasestorage.googleapis.com/v0/b/codedex-io.appspot.com/o/projects%2Fcreate-a-github-profile-pet-with-graphql%2Fbanner.webp?alt=media
readTime: 30
prerequisites: JavaScript, Node.js, GitHub account
versions: Next.js, GitHub GraphQL API
courses:
  - javascript
  - nodejs
  - git-github
...
<img width="800" height="auto" alt="githubsnake" src="https://firebasestorage.googleapis.com/v0/b/codedex-io.appspot.com/o/projects%2Fcreate-a-github-profile-pet-with-graphql%2Fgithubsnake.webp?alt=media" />

or a collect ion of stat cards that update dynamically?

<img width="400" height="auto" alt="githubstats" src="https://firebasestorage.googleapis.com/v0/b/codedex-io.appspot.com/o/projects%2Fcreate-a-github-profile-pet-with-graphql%2Fgithubstats.webp?alt=media" />
...
In this project tutorial, you’ll learn how to use GitHub GraphQL API, Next.js, and SVGs to display user stats on a multi-state README kitty widget! ⸜(｡˃ ᵕ ˂ )⸝♡

Example below ⤵︎⟢

<img width="300" height="auto" alt="widgetex" src="https://firebasestorage.googleapis.com/v0/b/codedex-io.appspot.com/o/projects%2Fcreate-a-github-profile-pet-with-graphql%2Fwidgetex.webp?alt=media" />
...
<img width="800" height="auto" alt="github credentials (1)" src="https://firebasestorage.googleapis.com/v0/b/codedex-io.appspot.com/o/projects%2Fcreate-a-github-profile-pet-with-graphql%2Fgithub-credentials.webp?alt=media" />
...
Next, we use a simple `if` statement:

- If the commit streak is 0, we return the sleeping cat asset. O
- therwise, we return our awake cat asset!
...
Let’s put all of this together! In route.ts import the helper functions `getGitHubStats()` to fetch the current GitHub streak, `getPetState()` to decide whether the cat should be sleeping or awake and `ASSETS` that contain Base64 data objects
...
Notice below that we’re using `<tspan>` tags instead of one large `<text>` element. This lets us style different parts of the same line. In this case, I made the actual streak number count font size a lot larger than the word “days”. 
...
The `"Content-Type": "image/svg+xml"` header is important because it tells browsers, especially GitHub, to render the response as an SVG instead of plain text
...
P.S. You can see how your widget would look on the web by running `npm run dev` in your project terminal.
...
<img width="800" height="auto" alt="full readme + widget" src="https://firebasestorage.googleapis.com/v0/b/codedex-io.appspot.com/o/projects%2Fcreate-a-github-profile-pet-with-graphql%2Ffinal-readme-widget.webp?alt=media" />
...
From here, you can customize it however you’d like by adding more kitty states and different stats using other [GitHub GraphQL queries](https://docs.github.com/en/graphql/reference?utm_source=chatgpt.com), animations, or something completely new!  ⋆ ·˚ ༘ *
