...
I first built this system while developing _[Before I Fade](https://www.codedex.io/community/project-showcase/ojhHfwsuyZZKPpU52UTg)_ for the Codédex Game Jam. The game is a murder mystery where you play as a ghost, searching for clues to uncover the truth behind your own death. Despite its simplicity, this single interaction system ended up powering everything from examining clues to progressing the story.

Once you finish this tutorial, you'll start spotting it all throughout the game... and hopefully find plenty of ways to use it in your own projects!
...
First, go ahead and download this [asset folder](https://drive.google.com/drive/folders/1PFkQHH8nX4CnLZWXYhQ5pWgJmV__gRTQ), as it contains all the assets that I will be using in this tutorial. Next, download Godot from [the official website](https://godotengine.org) if you don't already have it installed. 
...
**Note:** Some of the screenshots may not match if you're using a different version of Godot (ours is Godot 4.6). 
