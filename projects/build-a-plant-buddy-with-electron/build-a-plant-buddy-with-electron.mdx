...
First, close the app with <kbd>ctrl</kbd> + <kbd>C</kbd> (or <kbd>cmd</kbd> + <kbd>c</kbd> on Mac) in your terminal, same as we did in the CSS. Then open **main.js** and add `ipcMain` to your import:
